...
class Wheel(object):
    ...
    def _parse_metadata(self, file_object):
        ...
        message = message_from_bytes(file_object.read())
...
parser = argparse.ArgumentParser(description="Unpack a WHL file as a py_library.")

parser.add_argument("--whl", action="store", help=("The .whl file we are expanding."))
